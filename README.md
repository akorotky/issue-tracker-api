# About 
This repository contains the code for the backend of the full-stack Issue Tracker project. <br>
The frontend code can be found in the following [repository](https://github.com/akorotky/bugtracker-client).
